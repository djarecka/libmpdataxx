...
def d2_el_velocity_tot(lambx, lambx_t, lamby, lamby_t, x_range, y_range):
    v_tot = ( (x_range * lambx_t / lambx)**2 + (y_range * lamby_t / lamby)**2 )**0.5
    return np.where(x_range**2/lambx**2 + y_range**2/lamby**2 <= 1.,
                    v_tot, 0)
